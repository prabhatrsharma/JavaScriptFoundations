// Exercise 1: Fill in the missing arithmetic operators to get the expected result (replace the underscore symbol with the appropriate operator):
...
// Exercise 3: Fill in the missing logical operators in that such a way that all expressions result in true (replace the underscore symbol with the appropriate operator):
...
console.log(!false || false && true); //Alternate: console.log(false || false || true);
console.log(true && false || !(false && true)); //ALternate: console.log(true || false && false && true);
